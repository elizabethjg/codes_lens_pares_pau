...
python -u fit_pairs_profile.py -ncores 30 -folder ~/PARES-PAU/profiles_pk/ -file 'profile_pk_radio7_w1w3_Total-10radios.fits'  -RIN 300 -ROUT 10000 &
python -u fit_pairs_profile.py -ncores 30 -folder ~/PARES-PAU/profiles_pk/ -file 'profile_pk_radio7_w1w3_Gold-10radios.fits'  -RIN 300 -ROUT 10000 &
wait
